...
When no R code changed (Makefile, docs, CI only) but schema-related files were modified, run `make schema-validate`. When neither R code nor schemas changed, local verification may be skipped.
